...
const TOOL_ICONS = {
  tryhackme: `<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M10.705 0C7.54 0 4.902 2.285 4.349 5.291a4.525 4.525 0 0 0-4.107 4.5 4.525 4.525 0 0 0 4.52 4.52h6.761a.625.625 0 1 0 0-1.25H4.761a3.273 3.273 0 0 1-3.27-3.27A3.273 3.273 0 0 1 6.59 7.08a.625.625 0 0 0 .7-1.035 4.488 4.488 0 0 0-1.68-.69 5.223 5.223 0 0 1 5.096-4.104 5.221 5.221 0 0 1 5.174 4.57 4.489 4.489 0 0 0-.488.305.625.625 0 1 0 .731 1.013 3.245 3.245 0 0 1 1.912-.616 3.278 3.278 0 0 1 3.203 2.61.625.625 0 0 0 1.225-.251 4.533 4.533 0 0 0-4.428-3.61 4.54 4.54 0 0 0-.958.105C16.556 2.328 13.9 0 10.705 0Z"/></svg>`,
  hackthebox: `<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="m22.5106 6.4566.0008-.0123a.888.888 0 0 0-.2717-.6384c-.0084-.0084-.018-.0155-.0267-.0235-.0186-.0166-.0371-.0333-.0572-.0484-.0193-.0147-.04-.0276-.0607-.0406-.0096-.006-.0182-.0131-.0281-.0188L12.4576.1266a.891.891 0 0 0-.9223.0043L1.933 5.6744c-.0107.0062-.0203.014-.0307.0205-.0073.0047-.015.008-.0223.0128-.007.0047-.013.0106-.02.0155a.8769.8769 0 0 0-.147.1333l-.0026.003a.8872.8872 0 0 0-.2218.5847l.0009.014c-.0002.0088-.0015.0176-.0015.0264v11.0708c0 .3277.1802.6288.469.7836l9.5986 5.5417c.0076.0044.0158.0075.0236.0117a.8754.8754 0 0 0 .166.0687c.0134.004.0266.0083.0401.0117a.8793.8793 0 0 0 .072.0142c.0117.0019.0232.0045.0349.006a.835.835 0 0 0 .2157 0c.0117-.0015.0232-.0041.0348-.006a.9.9 0 0 0 .072-.0142c.0135-.0034.0267-.0077.04-.0117a.895.895 0 0 0 .0646-.0217.9134.9134 0 0 0 .1015-.047c.0078-.0042.016-.0072.0236-.0117l9.5986-5.5417a.8888.8888 0 0 0 .469-.7836V6.4779c0-.0071-.0012-.0142-.0014-.0213z"/></svg>`,
  portswigger: `<svg viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg"><path d="M338 0H640V640H338V602.5L559 383H338V209.5H176.5L338 46.5V0Z" fill="currentColor"/><path d="M0 0H309V39L93.5 244.5H309V418.5H485L309 593V640H0V0Z" fill="currentColor" opacity="0.55"/></svg>`,
  picoctf: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L3 7v5c0 4.5 3 9 9 11 6-2 9-6.5 9-11V7l-9-5Z"/><path d="M9 12h6M12 9v6"/></svg>`,
  juiceshop: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" xmlns="http://www.w3.org/2000/svg"><path d="M6 14c0 4 2.5 7 6 8.5 3.5-1.5 6-4.5 6-8.5V8L12 4 6 8v6Z"/><path d="M8 10v3l4 2 4-2v-3"/><path d="M10 5V3M14 5V3M9 2h6"/></svg>`
};
...
const PHASE_TOOLS = [
  {
    ...
    icon: 'tryhackme',
    reason: 'Pratica Linux, redes e fundamentos de segurança ofensiva em laboratórios guiados.'
  },
  {
    selector: '#col-2',
    name: 'PicoCTF',
    ...
    icon: 'picoctf',
    reason: 'Desafia o teu pensamento computacional com CTFs que combinam lógica e machine learning.'
  },
  {
    selector: '#col-3',
    ...
    icon: 'juiceshop',
    reason: 'Ambiente web realista para praticares AI security, prompt injection e teste de LLMs.'
  }
];

(function initPracticeFloat() {
  const el = document.getElementById('practiceFloat');
  const pfIcon = document.getElementById('pfIcon');
  const pfName = document.getElementById('pfName');
  const pfReason = document.getElementById('pfReason');
  ...
  function show(info) {
    ...
    pfIcon.innerHTML = TOOL_ICONS[info.icon] || '';
    pfName.textContent = info.name;
    pfReason.textContent = info.reason;
    pfBtn.href = info.url;
    el.style.display = '';
  }
  ...
  const observer = new IntersectionObserver(entries => {
    ...
    const info = best ? PHASE_TOOLS.find(p => best.matches(p.selector)) : null;
    if (info && info !== active) {
      active = info;
      show(info);
    } else if (!info && active) {
