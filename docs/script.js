...
const icons = {
  ...
  python: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.914 0C5.82 0 6.27 3.37 6.27 3.37l.006 3.44h5.715v1.033H3.9S0 5.87 0 11.968c0 6.097 3.403 5.877 3.403 5.877h2.024V11.47s-.108-3.403 3.34-3.403h5.76s3.24.052 3.24-3.14V3.39S18.027 0 11.914 0zM8.83 1.84a1.13 1.13 0 1 1 0 2.26 1.13 1.13 0 0 1 0-2.26z"/><path d="M12.086 24c6.094 0 5.642-3.37 5.642-3.37l-.006-3.44h-5.715v-1.033H20s6.27.45 6.27-5.647c0-6.097-3.403-5.877-3.403-5.877h-2.024v8.397s.108 3.403-3.34 3.403h-5.76s-3.24-.052-3.24 3.14v4.537S5.973 24 12.086 24zm3.084-1.84a1.13 1.13 0 1 1 0-2.26 1.13 1.13 0 0 1 0 2.26z"/></svg>`,
